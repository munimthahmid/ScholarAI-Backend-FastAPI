...
class SearchFilterService:
    ...
    def build_filters(self, source_name: str, domain: str = None, query: str = None) -> Dict[str, Any]:
        """
...
class SearchFilterService_Legacy(SearchFilterService):
    ...
    def _add_domain_filter(self, filters: Dict[str, Any], source_name: str, domain: str):
        """Legacy method - deprecated"""
    ...
    def _add_source_optimizations(self, filters: Dict[str, Any], source_name: str):
        """Legacy method - deprecated"""
        logger.warning("_add_source_optimizations is deprecated, use build_filters() instead")
