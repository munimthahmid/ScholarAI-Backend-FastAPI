...
try:
    ...
    logger.warning(f"Gemini AI not available: {AI_IMPORT_ERROR}. Query refinement disabled.")
...
class AIQueryRefinementService:
    ...
    async def generate_refined_queries(
        ...
        try:
            ...
            prompt = self._build_refinement_prompt(original_terms, domain, paper_context, max_queries)
    ...
    def _prepare_paper_context(self, papers: List[Dict[str, Any]], max_papers: int = 5) -> str:
        """
