...
class PaperDeduplicationService:
    ...
    def add_papers(self, papers: List[Dict[str, Any]]) -> int:
        ...
        logger.info(f"➕ Added {added_count} unique papers (deduplicated {len(papers) - added_count})")
        return added_count
    ...
    def get_deduplication_stats(self) -> Dict[str, int]:
        ...
        return {
            ...
            "avg_identifiers_per_paper": len(self.seen_papers) / max(len(self.added_papers), 1)
        } 