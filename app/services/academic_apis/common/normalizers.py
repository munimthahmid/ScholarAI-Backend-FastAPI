...
class PaperNormalizer:
    ...
    def normalize(raw_paper: Dict[str, Any], source: str) -> Dict[str, Any]:
        ...
        source_specific_data = PaperNormalizer._extract_source_specific(raw_paper, source)
    ...
    def _extract_venue(raw_paper: Dict[str, Any]) -> Optional[str]:
        ...
        venue_fields = [
            "venue", "venueName", "journal.name", "container-title",
            "journalName", "publication", "booktitle", "source"
        ]
    ...
    @staticmethod
    def _extract_source_specific(raw_paper: Dict[str, Any], source: str) -> Dict[str, Any]:
